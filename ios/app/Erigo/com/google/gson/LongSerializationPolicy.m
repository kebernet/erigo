...
//  source: /Volumes/Personal/Documents/raspi-config/client-framework/build/j2oSources/com/google/gson/LongSerializationPolicy.java
//
...
__attribute__((unused)) static ComGoogleGsonLongSerializationPolicy_2 *new_ComGoogleGsonLongSerializationPolicy_2_initWithNSString_withInt_(NSString *__name, jint __ordinal) NS_RETURNS_RETAINED;
...
ComGoogleGsonLongSerializationPolicy_1 *new_ComGoogleGsonLongSerializationPolicy_1_initWithNSString_withInt_(NSString *__name, jint __ordinal) {
  J2OBJC_NEW_IMPL(ComGoogleGsonLongSerializationPolicy_1, initWithNSString_withInt_, __name, __ordinal)
}

@implementation ComGoogleGsonLongSerializationPolicy_2

- (ComGoogleGsonJsonElement *)serializeWithJavaLangLong:(JavaLangLong *)value {
  return new_ComGoogleGsonJsonPrimitive_initWithNSString_(NSString_java_valueOf_(value));
}
...
ComGoogleGsonLongSerializationPolicy_2 *new_ComGoogleGsonLongSerializationPolicy_2_initWithNSString_withInt_(NSString *__name, jint __ordinal) {
  J2OBJC_NEW_IMPL(ComGoogleGsonLongSerializationPolicy_2, initWithNSString_withInt_, __name, __ordinal)
}
