...
//  source: /Volumes/Personal/Documents/raspi-config/client-framework/build/j2oSources/com/google/gson/internal/ConstructorConstructor.java
//
...
- (id<ComGoogleGsonInternalObjectConstructor>)getWithComGoogleGsonReflectTypeToken:(ComGoogleGsonReflectTypeToken *)typeToken {
  ...
  if (typeCreator != nil) {
    return new_ComGoogleGsonInternalConstructorConstructor_1_initWithComGoogleGsonInstanceCreator_withJavaLangReflectType_(typeCreator, type);
  }
  id<ComGoogleGsonInstanceCreator> rawTypeCreator = [instanceCreators_ getWithId:rawType];
  if (rawTypeCreator != nil) {
    return new_ComGoogleGsonInternalConstructorConstructor_2_initWithComGoogleGsonInstanceCreator_withJavaLangReflectType_(rawTypeCreator, type);
  }
...
id<ComGoogleGsonInternalObjectConstructor> ComGoogleGsonInternalConstructorConstructor_newDefaultConstructorWithIOSClass_(ComGoogleGsonInternalConstructorConstructor *self, IOSClass *rawType) {
  @try {
    ...
    return new_ComGoogleGsonInternalConstructorConstructor_3_initWithJavaLangReflectConstructor_(constructor);
  }
...
id<ComGoogleGsonInternalObjectConstructor> ComGoogleGsonInternalConstructorConstructor_newDefaultImplementationConstructorWithJavaLangReflectType_withIOSClass_(ComGoogleGsonInternalConstructorConstructor *self, id<JavaLangReflectType> type, IOSClass *rawType) {
  if ([JavaUtilCollection_class_() isAssignableFrom:rawType]) {
    if ([JavaUtilSortedSet_class_() isAssignableFrom:rawType]) {
      return new_ComGoogleGsonInternalConstructorConstructor_4_init();
    }
    else if ([JavaUtilEnumSet_class_() isAssignableFrom:rawType]) {
      return new_ComGoogleGsonInternalConstructorConstructor_5_initWithJavaLangReflectType_(type);
    }
    else if ([JavaUtilSet_class_() isAssignableFrom:rawType]) {
      return new_ComGoogleGsonInternalConstructorConstructor_6_init();
    }
    else if ([JavaUtilQueue_class_() isAssignableFrom:rawType]) {
      return new_ComGoogleGsonInternalConstructorConstructor_7_init();
    }
    else {
      return new_ComGoogleGsonInternalConstructorConstructor_8_init();
    }
  }
  if ([JavaUtilMap_class_() isAssignableFrom:rawType]) {
    if ([JavaUtilConcurrentConcurrentNavigableMap_class_() isAssignableFrom:rawType]) {
      return new_ComGoogleGsonInternalConstructorConstructor_9_init();
    }
    else if ([JavaUtilConcurrentConcurrentMap_class_() isAssignableFrom:rawType]) {
      return new_ComGoogleGsonInternalConstructorConstructor_10_init();
    }
    else if ([JavaUtilSortedMap_class_() isAssignableFrom:rawType]) {
      return new_ComGoogleGsonInternalConstructorConstructor_11_init();
    }
      ...
      return new_ComGoogleGsonInternalConstructorConstructor_12_init();
    }
    else {
      return new_ComGoogleGsonInternalConstructorConstructor_13_init();
    }
  }
  return nil;
}
...
id<ComGoogleGsonInternalObjectConstructor> ComGoogleGsonInternalConstructorConstructor_newUnsafeAllocatorWithJavaLangReflectType_withIOSClass_(ComGoogleGsonInternalConstructorConstructor *self, id<JavaLangReflectType> type, IOSClass *rawType) {
  return new_ComGoogleGsonInternalConstructorConstructor_14_initWithIOSClass_withJavaLangReflectType_(rawType, type);
}
