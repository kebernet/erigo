...
//  source: /Volumes/Personal/Documents/raspi-config/client-framework/build/j2oSources/com/google/gson/internal/bind/ArrayTypeAdapter.java
//
...
+ (void)initialize {
  if (self == [ComGoogleGsonInternalBindArrayTypeAdapter class]) {
    ComGoogleGsonInternalBindArrayTypeAdapter_FACTORY = new_ComGoogleGsonInternalBindArrayTypeAdapter_1_init();
