...
//  source: /Volumes/Personal/Documents/raspi-config/client-framework/build/j2oSources/com/google/gson/internal/bind/DateTypeAdapter.java
//
...
+ (void)initialize {
  if (self == [ComGoogleGsonInternalBindDateTypeAdapter class]) {
    ComGoogleGsonInternalBindDateTypeAdapter_FACTORY = new_ComGoogleGsonInternalBindDateTypeAdapter_1_init();
...
- (ComGoogleGsonTypeAdapter *)createWithComGoogleGsonGson:(ComGoogleGsonGson *)gson
                        withComGoogleGsonReflectTypeToken:(ComGoogleGsonReflectTypeToken *)typeToken {
  return [((ComGoogleGsonReflectTypeToken *) nil_chk(typeToken)) getRawType] == JavaUtilDate_class_() ? new_ComGoogleGsonInternalBindDateTypeAdapter_init() : nil;
}
