...
//  source: /Volumes/Personal/Documents/raspi-config/client-framework/build/j2oSources/com/google/gson/internal/bind/ObjectTypeAdapter.java
//
...
+ (void)initialize {
  if (self == [ComGoogleGsonInternalBindObjectTypeAdapter class]) {
    ComGoogleGsonInternalBindObjectTypeAdapter_FACTORY = new_ComGoogleGsonInternalBindObjectTypeAdapter_1_init();
