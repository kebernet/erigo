...
//  source: /Volumes/Personal/Documents/raspi-config/client-framework/build/j2oSources/com/google/gson/internal/bind/SqlDateTypeAdapter.java
//
...
+ (void)initialize {
  if (self == [ComGoogleGsonInternalBindSqlDateTypeAdapter class]) {
    ComGoogleGsonInternalBindSqlDateTypeAdapter_FACTORY = new_ComGoogleGsonInternalBindSqlDateTypeAdapter_1_init();
...
- (ComGoogleGsonTypeAdapter *)createWithComGoogleGsonGson:(ComGoogleGsonGson *)gson
                        withComGoogleGsonReflectTypeToken:(ComGoogleGsonReflectTypeToken *)typeToken {
  return [((ComGoogleGsonReflectTypeToken *) nil_chk(typeToken)) getRawType] == JavaSqlDate_class_() ? new_ComGoogleGsonInternalBindSqlDateTypeAdapter_init() : nil;
}
