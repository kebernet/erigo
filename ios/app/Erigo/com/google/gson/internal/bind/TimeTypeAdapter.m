...
//  source: /Volumes/Personal/Documents/raspi-config/client-framework/build/j2oSources/com/google/gson/internal/bind/TimeTypeAdapter.java
//
...
+ (void)initialize {
  if (self == [ComGoogleGsonInternalBindTimeTypeAdapter class]) {
    ComGoogleGsonInternalBindTimeTypeAdapter_FACTORY = new_ComGoogleGsonInternalBindTimeTypeAdapter_1_init();
...
- (ComGoogleGsonTypeAdapter *)createWithComGoogleGsonGson:(ComGoogleGsonGson *)gson
                        withComGoogleGsonReflectTypeToken:(ComGoogleGsonReflectTypeToken *)typeToken {
  return [((ComGoogleGsonReflectTypeToken *) nil_chk(typeToken)) getRawType] == JavaSqlTime_class_() ? new_ComGoogleGsonInternalBindTimeTypeAdapter_init() : nil;
}
