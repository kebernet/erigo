...
//  source: /Volumes/Personal/Documents/raspi-config/client-framework/build/j2oSources/com/google/gson/reflect/TypeToken.java
//
...
- (jboolean)isAssignableFromWithJavaLangReflectType:(id<JavaLangReflectType>)from {
  ...
  if ([type_ isKindOfClass:[IOSClass class]]) {
    ...
    @throw nil_chk(ComGoogleGsonReflectTypeToken_buildUnexpectedTypeErrorWithJavaLangReflectType_withIOSClassArray_(type_, [IOSObjectArray newArrayWithObjects:(id[]){ IOSClass_class_(), JavaLangReflectParameterizedType_class_(), JavaLangReflectGenericArrayType_class_() } count:3 type:IOSClass_class_()]));
  }
}
...
ComGoogleGsonReflectTypeToken *ComGoogleGsonReflectTypeToken_getParameterizedWithJavaLangReflectType_withJavaLangReflectTypeArray_(id<JavaLangReflectType> rawType, IOSObjectArray *typeArguments) {
  ComGoogleGsonReflectTypeToken_initialize();
  return new_ComGoogleGsonReflectTypeToken_initWithJavaLangReflectType_(ComGoogleGsonInternal_Gson_Types_newParameterizedTypeWithOwnerWithJavaLangReflectType_withJavaLangReflectType_withJavaLangReflectTypeArray_(nil, rawType, typeArguments));
}
...
ComGoogleGsonReflectTypeToken *ComGoogleGsonReflectTypeToken_getArrayWithJavaLangReflectType_(id<JavaLangReflectType> componentType) {
  ComGoogleGsonReflectTypeToken_initialize();
  return new_ComGoogleGsonReflectTypeToken_initWithJavaLangReflectType_(ComGoogleGsonInternal_Gson_Types_arrayOfWithJavaLangReflectType_(componentType));
}
