...
public class Scanner {
     ...
     *
     * @param prefilter The URLFilter that will determine whether or not a URL should
     ...
     *
     * @param loaders The <code>java.lang.ClassLoaders</code> to add resources for.
     * @throws ScanException If an error occurs while attempting to add resources to the
     *                       classpath.
     */
     ...
     * @throws ScanException If the file name is invalid.
     */
     ...
     *
     * @param jarDirs The paths to directories containing jar files.
     * @throws ScanException if a bad directory is specified.
     */
     ...
     *
     * @throws ScanException If an error occurs whilst attempting to scan the boot class
     *                       path.
     */
     ...
     * files will be added.
     *
     * @throws ScanException If an error occurs whilst attempting to add the paths.
     */
     ...
     *
     * @throws ScanException If an error occurs while attempting to scan the endorsed
     *                       directories.
     */
     ...
     *
     * @throws ScanException If an error occurs while attempting to scan the ext
     *                       directories.
     */
     ...
     *
     * @throws ScanException If an error occurs while attempting to add the paths.
     */
     ...
     *
     * @param filter The {@link ScanFilter} to use for the scan.
     * @return The list of resources that matches the filter.
     * @throws ScanException If an error occurs while scanning the class path.
     */
     ...
     * do not exist.
     *
     * @param prefilter the prefilter to use
     */
